...
const features = [
  ...
  },
  {
    title: 'Pig Paradise',
    description:
      "We raise top-quality pigs that meet modern demands. Our commitment ensures excellence and higher\
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            All the meat you need for that sumptuous meal!
          </h2>
          <p className="mt-6 text-lg tracking-tight text-green-100">
            We offer full animal sales or meat sales.
          </p>
        </div>
        <Tab.Group
          as="div"
